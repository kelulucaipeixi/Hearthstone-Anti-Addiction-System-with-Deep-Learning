...
train,train_label=get_files('Z:\\lushi\\recong\\train_image\\')

train_batch, train_label_batch = get_batches(train, train_label, 64, 64, 100, 20)

train_logits = model.inference(train_batch, 100, 2)
